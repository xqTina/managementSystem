...
layui.use(['form', 'laydate', 'util','table','treeTable'], function () {
    ...
    treetable.render({
        ...
        cols: [[
            ...
            // {field: 'dtuDtuId', title: 'DTU序列号', minWidth: 150, sort: true},
            {field: 'name', title: 'DTU序列号', width: 150, fixed: 'left', templet: '<i class="iconfont icon-xinhao-online"></i>'},
            // {field: 'dtuDtuId', title: 'DTU序列号', minWidth: 150, sort: true},
            {field: 'deviceDeviceId', title: '设备序列号', minWidth: 100,sort: true},
            {field: 'address', title: 'DTU地址', minWidth: 150, sort: true},
