        ...
        success:function () {
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    {field: 'data4', title: '数据5', minWidth: 100, sort: true},
                    {field: 'data5', title: '数据6', minWidth: 100, sort: true},
                    {field: 'data6', title: '数据7', minWidth: 100, sort: true},
                    {field: 'data7', title: '数据8', minWidth: 100, sort: true},
                    {field: 'data8', title: '数据9', minWidth: 100, sort: true},
                    {field: 'data9', title: '数据10', minWidth: 100, sort: true},
                    {field: 'data10', title: '数据11', minWidth: 100, sort: true},
                    {field: 'data11', title: '数据12', minWidth: 100, sort: true},
                    {field: 'data12', title: '数据13', minWidth: 100, sort: true},
                    {field: 'data13', title: '数据14', minWidth: 100, sort: true},
                    {field: 'data14', title: '数据15', minWidth: 100, sort: true},
                    {field: 'data15', title: '数据16', minWidth: 100, sort: true},
                ]]
            });
        },
        btn: ['确定'],
