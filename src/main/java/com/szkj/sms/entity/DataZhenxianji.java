 ...
 */
@TableName(value = "data_zhenxianji")
@Data
public class DataZhenxianji implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        DataZhenxianji other = (DataZhenxianji) that;
...
//    }
    ...
    public String toString() {
        ...
        sb.append(", temperature=").append(temperature);
        sb.append(", freqency=").append(freqency);
        sb.append(", yingbian=").append(yingbian);
